...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="registro.php" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" name="txtApellido" class="form-control" placeholder="Apellido(s)(*)">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input type="file" name="txtFoto" class="form-control" placeholder="Foto de perfil">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name="btnRegistro" class="btn btn-primary btn-block btn-flat">Register</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
